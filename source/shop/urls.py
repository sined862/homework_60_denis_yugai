...
from shop.views.products import ProductView, ProductAddView, ProductUpdateView, ProductDelView, ProductDelConfirmView, CreateOrderView, ProductAddToCart
from shop.views.products import categories_view, del_cart_view
...
urlpatterns = [
    ...
    path('to_cart/<int:pk>', ProductAddToCart.as_view(), name='to_cart'),
